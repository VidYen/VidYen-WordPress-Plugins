 ...
 */
 ...
 add_action('admin_menu', 'vyps_lb_menu'); //Note dropping the number so I think it should sort alpha

/* Create the menu if VYPS not installed */

function vyps_lb_menu() 
{
	
    $parent_page_title = "Leaderboard: VYPS not installed!";
    $parent_menu_title = 'VYPS Leaderboard';
    $capability = 'manage_options';
    $parent_menu_slug = 'vyps_lb';
    $parent_function = 'vyps_lb_parent_menu_page';
...
function vyps_lb_parent_menu_page() 
{ 
