	...
	$mission_html_output .=
		'<table width="100%">
          ...
          <div id="trainsoldiersCoolDownTimer" style="width:100%; height: 30px; background-color: #b30b00;">
						<div id="train_soldiers_countdown_time_left" style="position: absolute; right:12%; color:white; font-size:1.25vw;"></div><div style="text-align: right;">'.$soldier_icon.'</div>
					</div>
        </div>
				</td>
			</tr>
