...
//  }  $soldiers_killed1 = 5000 - $soldiers_killed(25);
  ...
  //{
    ...
    elseif ($soldiers_killed < 50 || $money_looted2 > $soldiers_killed1)
    {
      //$lootss = 5000;
    ...
    elseif ($soldiers_killed < 100)
    {
      ...
      $story = "Your soldiers attack but forget to bring assassins with them and take some light casualties with $soldiers_killed soldiers lost. They remaining are too rather saddened by the lose and half heartedly carry back iron and stone.";
      $loot = "You received $iron_looted iron ore and $stone_looted units of stone." ;
    ...
    elseif ($soldiers_killed < 500)
    {
      ...
      $loot = "You received $iron_looted iron ore." ;
      $stone_looted = 0; //Just had to reset that.
      $iron_looted = 0;
      $wood_looted = 0;
    }
