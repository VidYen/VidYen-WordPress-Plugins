...
function vidyen_rts_sack_castle_action()
{
  ...
  $iron_looted = mt_rand( 0 , 750 );
  $stone_looted = mt_rand( 0 , 500 ); //Why would you loot stone?
...
//  }  $soldiers_killed1 = 5000 - $soldiers_killed(25);
  ...
  //{
    ...
    elseif ($soldiers_killed < 40 || $money_looted2 > $soldiers_killed1)
    {
      //$lootss = 5000;
      //$money_looted2 = $lootss - $soldiers_killed(25);
      $lootss = 5000;
      $soldiers_killed1 = $soldiers_killed*25;
      $money_looted2 = $lootss - $soldiers_killed1;
      ...
      $loot = "You received $money_looted2 copper coins, $wood_looted wood, $iron_looted iron ore, and $stone_looted units of stone.";
    ...
    elseif ($soldiers_killed < 80)
    {
      ...
      $loot = "You received $money_looted2 copper coins, $wood_looted wood, and $iron_looted iron ore." ;
    ...
    elseif ($soldiers_killed < 130)
    {
      ...
      $loot = "You received $money_looted2 copper coins and $wood_looted wood.";
      $stone_looted = 0; //Just had to reset that.
      $iron_looted = 0;
    }
    elseif ($soldiers_killed < 200)
    {
      ...
      $loot = "You received $money_looted2 in copper coins." ;
      $stone_looted = 0; //Just had to reset that.
      $iron_looted = 0;
      $wood_looted = 0;
    }
