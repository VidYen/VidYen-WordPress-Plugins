...
/* Ok. After beating my head again the wall trying to determine if a site has bootstrap css on it.
*  I am just going to add a whole other shortcode that one can just use if they know their theme has it
*  and leave the onus on theme decision on the site admin. AKA It works for me. -Felty
*/

function pt_mod_func( $atts ) {
...
//return "End of the line!";
	...
	*/
	...
	return "<form method=\"post\">
			...
			<script>
				document.addEventListener(\"load\", alert(\"$pt_sAmount $sourceName spent for $pt_dAmount $destName earned.\"));
			</script>
			";
...
add_shortcode( 'vyps-pt-mod', 'pt_mod_func');
