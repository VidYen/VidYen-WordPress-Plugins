...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
 ...
 echo "<br><br>
	...
	<p>This plugin needs VYPS Base and two point types to function. The intention is to allow a quick and easy way for users to transfer one type of point to another at varying rates</p>
	...
	<p>The earn attribute is how much currency the user gets in the other point type. The spend attribute is how many VYPS points is spent.</p>
  ...
  <p><b>[vyps-pt-ww spid=1 samount=100000 damount=0.010]</b></p>
	<p>Creates table transfer menu to transfer points to the WooWallet if you have it installed. This shortcode needs both VYPS and <a href=\"https://wordpress.org/plugins/woo-wallet/\" target=\"_blank\">WooCommerce Wallet</a> to function.
	As its assumed that you are going straight to WooWallet there is no need to set dpid, but you still need to set damount.</p>
