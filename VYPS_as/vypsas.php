...
/*** OK. Adding redeem with button. Copy and paste of above function in case admin did not want GUI ***/

function as_redeem_btn_func( $atts ) {
...
add_shortcode( 'vyps-as-redeem-btn', 'as_redeem_btn_func');
