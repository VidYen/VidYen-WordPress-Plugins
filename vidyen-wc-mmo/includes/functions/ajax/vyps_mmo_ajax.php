...
add_action('wp_ajax_vyps_mmo_api_action', 'vyps_mmo_api_action');

//register the ajax for non authenticated users
add_action( 'wp_ajax_nopriv_vyps_momo_api_action', 'vyps_mmo_api_action' );

// handle the ajax request
function vyps_mmo_api_action()
{
