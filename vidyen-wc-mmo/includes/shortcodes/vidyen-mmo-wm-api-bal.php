...
function vidyen_mmo_wm_postback_api_bal_func( $atts )
{
	...
	if ($atts['mode']=='GET')
	{
		if (isset($_GET['userid']))
		{
			...
			$game_id = sanitize_text_field($_GET['userid']);
			//$user_id = 1; //Hard coded for now
			$mmo_get_balance = vidyen_mmo_wm_point_balance_func($point_id, $game_id);
		}
		else
		{
			$mmo_get_balance = 0;
...
add_shortcode( 'vidyen-mmo-wm-api-bal', 'vidyen_mmo_wm_postback_api_bal_func');
