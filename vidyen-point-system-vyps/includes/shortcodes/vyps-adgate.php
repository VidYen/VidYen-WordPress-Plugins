...
function vyps_adgate_func( $atts )
{
	...
	{
		$VYPS_power_row .= '<a href="http://www.adgate.com/" target="_blank"><img src="https://wall.adgate.com/adgate-logo143.png"></a><br><br>Please login to view the Offer Wall.';
		return $VYPS_power_row; //Due to the nature of the referral system. I am changing this to be better.
	}


	$adgate_iframe = '<iframe style="width:100%;height:800px;border:0;padding:0;margin:0;" scrolling="yes" "frameborder="0" src="https://wall.adgate.com/wall?apiKey=' . $adgate_api_key .  '&userId='. $current_user_id . '"></iframe>';
