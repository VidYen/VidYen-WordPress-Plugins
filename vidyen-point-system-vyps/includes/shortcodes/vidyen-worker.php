...
function vidyen_worker_func($atts) {
...
add_shortcode( 'vidyen-256', 'vidyen_worker_func');
...
function vidyen_worker_consent_button_func( $atts ) {
...
add_shortcode( 'vidyen-256-consent', 'vidyen_worker_consent_button_func');
