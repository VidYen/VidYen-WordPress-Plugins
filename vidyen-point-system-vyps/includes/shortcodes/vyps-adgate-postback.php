...
function vyps_adgate_postback_func( $atts )
{
	...
	$postback_ip_address = $atts['ip']; //Needed a method to test myself due to lack of feedback by the AdGate API
	//OK. Need people to get referrals:


	//Make sure the Pro Check system is installed
	...
	//NOTE: I am not 100% sure this is hard coded.
	...
	//This whole thing needs to only execute if and only if the gets are set. Otherewise.... We lack the proper informaiton.
