...
add_action('wp_ajax_vidyen_wm_set_cookie_action', 'vidyen_wm_set_cookie_action');

//register the ajax for non authenticated users
add_action( 'wp_ajax_nopriv_vidyen_wm_set_cookie_action', 'vidyen_wm_set_cookie_action' );

// handle the ajax request
function vidyen_wm_set_cookie_action()
{
...
add_action('wp_head', 'vidyen_wm_set_ajaxurl');

function vidyen_wm_set_ajaxurl()
{
