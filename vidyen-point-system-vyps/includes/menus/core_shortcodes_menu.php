...
function vyps_core_shortcodes_sub_menu_page()
{
  ...
  <p>You can set shortcode option to refer=10 in either the [vyps-pe] or [vyps-256] to give 10% referral reward to the user who entered their referral code. There will be no forthcoming addition to Adscend or Coinhive refer codes, but you can gate those points through the point-exchange system easy enough.</p>
