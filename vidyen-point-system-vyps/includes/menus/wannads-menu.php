...
function vyps_wannads_sub_menu_page()
{
  ...
  echo '<br><br><h1>VYPS Adscend Media User Tracking API Shortcodes</h1>
	...
	<p>4. Make sure no other text or shortcode in page body. (It will cause errors on the Adscend side if you do)</p>
	...
	<p>Note: VYPS will do a 1 for 1 and round to the closet whole number based on the Wannads settings on their site. Simply set your Wannads Data to more than 100 per $1.00 USD and set their system to currency round.</p>
 ';
}
