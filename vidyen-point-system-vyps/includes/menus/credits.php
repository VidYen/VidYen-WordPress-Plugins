...
echo "
  <h1>Pro Version</h1>
  <p>There is a pro-plugin valid until 2020 available for purchase on the <a href=\"https://www.vidyen.com/product/vyps-pro-install/\" target=\"_blank\">VidYen</a> store.</p>
  <p>It will remove the VYPS branding on the monetization pages. NOTE: You can use VYPS to earn credit towards its purchase.</p>
