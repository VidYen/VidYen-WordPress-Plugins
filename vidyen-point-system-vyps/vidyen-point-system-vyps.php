...
include( plugin_dir_path( __FILE__ ) . 'includes/functions/core/vidyen_user_display_name.php'); //Log for just the user. This was a long time coming. I may had some gets.
